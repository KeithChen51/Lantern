...
// Local subset of the locked Solar icon system used by Lighthouse.
// Keeping this small avoids remote icon fetches and avoids bundling the full Solar collection.
export const solarIconSet = {
  "prefix": "solar",
  "icons": {
    "map-point-wave-bold": {
