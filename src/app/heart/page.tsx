...
"面向客户，求真意味着如实说明车况、费用、依据、进度、风险和不确定性。不夸大问题，不隐瞒失误，不让客户事后才知道关键事实。",
    employee:
"面向员工，求真意味着讲清目标、规则、评价标准。组织不能用模糊承诺来管理团队，也不能把流程、资源和管理问题简单归结为员工个人问题。",
    actions: ["能确认的事实，当场讲清楚。", "不能确认的事项，明确下一步和责任人。", "面向客户，避免制造信息差；面向员工，避免制造规则差。"],
  },
  {
    title: "尽善",
    focus: "选择有益",
...
"面向客户，尽善不是无原则让利，也不是一味迁就，而是在标准允许的范围内多解释一步、多协调一步、多减少一次等待。",
    employee:
"面向员工，尽善意味着不把客户满意建立在员工单方面牺牲上，而要给出支持、授权和复盘。",
    actions: [
      "不把“流程规定”当成推诿理由。",
  ...
  },
  {
    ...
    customer:
"面向客户，致美体现在清晰有效的流程、整洁有序的现场、准确克制的表达和稳定可追踪的交付中；也体现在钣喷、维修等高专业度场景里从破损到修复、从混乱到秩序的工艺之美。",
    employee:
"面向员工，致美体现在整齐的服务工具、合理的排班、顺畅的协作和专业的现场管理中。流程清楚，工序衔接顺畅，标准被认真执行，员工才更容易把专业做出来。",
  ...
  },
  {
    ...
    customer:
"面向客户，大爱体现在对具体处境的体察。客户遇到事故、返修、异地用车、家庭出行、安全风险或长期信任受挫时，服务不能只剩条款和话术。先理解他的担心、损失和不便，再回到规则中寻找可承担、可交代的解法。",
    employee:
"面向员工，大爱体现在对安全、尊严、成长和承压状态的关心。员工面对客户情绪、复杂工单、加班压力和跨部门协作时，组织不能只要求“扛住”，而要给出支持、授权、复盘和保护。",
    society:
      "面向社会，大爱要求把企业经营放在更长远的公共责任之中，以真诚、专业、守信的服务维护行业秩序，减少资源浪费，保护环境，推动构建更安全、更可靠、更有温度的汽车服务生态。",
    actions: ["先看见人的处境，再回到规则中找解法。", "面向客户：体现温度；面向员工：给予支持、边界与保护。", "把服务行为放回长期关系和公共责任中审视。"],
  },
  {
    title: "幸福",
    focus: "共同归处",
...
"面向客户，幸福不是简单的满意评分，而是感到安心、被尊重，并愿意继续托付。",
    employee:
"面向员工，幸福是在真实压力中仍然被支持、被尊重、能成长。员工知道标准在哪里，资源从哪里来，问题可以如何被复盘，而不是把所有压力都变成个人承担。",
    organization:
